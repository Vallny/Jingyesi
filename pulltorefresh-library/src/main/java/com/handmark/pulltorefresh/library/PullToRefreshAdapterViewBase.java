...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements OnScrollListener {
	...
	private ImageLoaderScrollListener imageLoaderScrollListener;
	...
	public void setOnImageLoaderScrollListener(ImageLoaderScrollListener imageLoaderScrollListener) {
		this.imageLoaderScrollListener = imageLoaderScrollListener;
	}
	...
	public final void onScrollStateChanged(final AbsListView view, final int state) {
		 ...
		 * visible.
		 */
		if (null != imageLoaderScrollListener) {
			imageLoaderScrollListener.onScrollStateChanged(state);
		}
