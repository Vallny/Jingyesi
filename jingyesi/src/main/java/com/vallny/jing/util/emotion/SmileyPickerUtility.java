package com.vallny.jing.util.emotion;
...
public class SmileyPickerUtility {
	...
	public static int getKeyboardHeight(Activity paramActivity,boolean showAnimation,int content_height) {
		
//		int height = SmileyPickerUtility.getScreenHeight(paramActivity) - SmileyPickerUtility.getStatusBarHeight(paramActivity) - SmileyPickerUtility.getAppHeight(paramActivity);
//		if (height == 0) {
//			height = 400;
//		}
		int height = SmileyPickerUtility.getScreenHeight(paramActivity) - 2*SmileyPickerUtility.getStatusBarHeight(paramActivity) - content_height;
		return height;
	}
