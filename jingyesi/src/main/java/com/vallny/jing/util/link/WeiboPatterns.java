package com.vallny.jing.util.link;
...
public class WeiboPatterns {
	...
	public static final String TOPIC_SCHEME = "com.vallny.jing.topic://";

	public static final String MENTION_SCHEME = "com.vallny.jing://";
